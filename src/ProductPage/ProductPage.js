        ...
        <div className="productpage-container">
            ...
            <main>
                ...
                <div className="box2">
                    ...
                    <p>Product Description - Lorem ipsum dolor sit amet, consectetur adipiscing elit donec consectetur semper nunc in molestie. </p>
                    <span><h3>£500</h3><p>£600</p></span>
                    ...
                    <div className="productpage-colour-container" style={{marginTop:0}}>
                        <div className="colorCircle" style={{backgroundColor: "black"}}></div>
            ...
            <section>
                <div className="product-description">
                    <h3>Description</h3>
                    <p>Product Description - Lorem ipsum dolor sit amet, consectetur adipiscing elit donec consectetur semper nunc in molestie. 
                    <br/>
                    <br/>
